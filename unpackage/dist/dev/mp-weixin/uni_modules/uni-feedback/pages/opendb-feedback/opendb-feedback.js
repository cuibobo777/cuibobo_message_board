...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    n: common_vendor.sr("form", "6fae4dce-0"),
    o: common_vendor.p({
      value: $data.formData,
      ["validate-trigger"]: "submit",
      ["err-show-type"]: "toast"
    }),
    p: _ctx.uniIDHasRole("webmaster") || _ctx.uniIDHasRole("admin")
  }, _ctx.uniIDHasRole("webmaster") || _ctx.uniIDHasRole("admin") ? {
    q: common_vendor.sr("fab", "6fae4dce-8"),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/Cuibobo_Projects/HBuilderProjects/Orebo-admin/uni_modules/uni-feedback/pages/opendb-feedback/opendb-feedback.vue"]]);
