...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    t: common_vendor.sr("shortCode", "51db9a13-10,51db9a13-9"),
    ...
    y: common_vendor.sr("agreements", "51db9a13-11,51db9a13-0"),
    z: common_vendor.p({
      scope: "register"
    }),
    ...
    E: common_vendor.sr("form", "51db9a13-0"),
    F: common_vendor.p({
      value: $data.formData,
      rules: $data.rules,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/Cuibobo_Projects/HBuilderProjects/Orebo-admin/uni_modules/uni-id-pages/pages/register/register-by-email.vue"]]);
